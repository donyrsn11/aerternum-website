...
- Merge ke `main` → Vercel deploy ke **Production** (situs asli berubah)

**Default: kerjakan di branch, jangan langsung ke `main`.** Selalu berikan
link preview-nya supaya bisa dicek dulu. Push langsung ke `main` hanya kalau
diminta eksplisit.

<!-- Kalau nanti lebih suka langsung live tanpa preview, ganti paragraf di atas
     jadi: "Default: commit dan push langsung ke main." -->
